...
if ( ! class_exists( 'Kirki_Controls_Column_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Kirki_Controls_Column_Control extends Kirki_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'kirki-column' );
		}
