...
if ( ! class_exists( 'Kirki_Init' ) ) {
	...
	class Kirki_Init {
		...
		public function register_control_types() {
			...
			$wp_customize->register_control_type( 'Kirki_Controls_Accordion_Control' );//@thim_created
			...
			$wp_customize->register_control_type( 'Kirki_Controls_Column_Control' );

			/**
			 * Register new controls
			 */
			$wp_customize->register_control_type( 'Kirki_Controls_Image_Control' );
			$wp_customize->register_control_type( 'Kirki_Controls_Upload_Control' );
		}
