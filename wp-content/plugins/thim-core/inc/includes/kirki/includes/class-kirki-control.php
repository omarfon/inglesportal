	...
	class Kirki_Control {
		...
		final private function set_control_types() {
			...
			$this->control_types = apply_filters( 'kirki/control_types', array(
				...
				'kirki-accordion'       => 'Kirki_Controls_Accordion_Control',//@thim_created
				...
				'cropped_image' => 'WP_Customize_Cropped_Image_Control',
				'kirki-column'  => 'Kirki_Controls_Column_Control',

				/**
				 * Added by TuNN on Sep 06 2016
				 * Register new controls
				 */
				'kirki-image'   => 'Kirki_Controls_Image_Control',
				'kirki-upload'  => 'Kirki_Controls_Upload_Control'
			) );
