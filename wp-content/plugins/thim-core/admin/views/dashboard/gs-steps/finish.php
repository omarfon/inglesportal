...
<div class="top">
	...
	<div class="row">
		<div class="col-md-6">
			<h3>Next Steps</h3>
			<ul>
				<li><a class="button button-primary tc-button" href="https://www.facebook.com/ThimPress/" target="_blank">Follow Facebook</a></li>
				<li><a class="button button-secondary tc-button" href="<?php echo get_home_url(); ?>" target="_blank">View Your Site</a></li>
			</ul>
		</div>
		<div class="col-md-6">
...
<div class="bottom">
	...
	<a href="<?php echo esc_url( Thim_Dashboard::get_link_main_dashboard() ); ?>"
	   class="button button-primary tc-button tc-run-step">
		<?php esc_html_e( 'Go to dashboard', 'thim-core' ); ?>
	</a>
</div>