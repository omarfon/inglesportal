(function ($) {
    ...
    var Thim_Form_Import = Backbone.View.extend({
        ...
        _initImport: function () {
            ...
            this.current_request = $
                .ajax({
                    url: this.model.get('admin_ajax_action'),
                    method: 'POST',
                    data: {
                        demo: demo.key,
                        packages: packages
        ...
        _notifyError: function (details) {
            ...
            this.$('.wrapper-finish').removeClass('success').addClass('failed');
            this._finish();
    ...
    var Thim_Form_Uninstall = Backbone.View.extend({
        ...
        startUninstall: function () {
            ...
            this.current_request = $.ajax({
                url: this.model.get('admin_ajax_uninstall'),
                method: 'POST',
                dataType: 'text'
            })
                .success(function (response) {
    ...
    var Thim_Importer_V2 = Backbone.View.extend({
        ...
        updateDemoInstalled: function () {
            ...
            this.$('.thim-demo').removeClass('installed');

            if (!installed) {
                return;
            }

            this.$('.thim-demo[data-thim-demo="' + installed + '"]').addClass('installed');
        },
