...
class Thim_Layout_Builder extends Thim_Singleton {
	 ...
	 * @return string
	 */
	public static function render_content( $content, $builder, $fake_ip ) {
		if ( $builder == 'so' ) {
			...
			return siteorigin_panels_render( $fake_ip, true, $content );
		}
	...
	public function override_template_preview() {
		...
		if ( $post_type == self::$post_type ) {
			$file = THIM_CORE_ADMIN_PATH . '/views/layout-builder/preview.php';
