...
$header->createOption( array(
	...
	'type'    => 'radio-image',
	'options' => array(
		"header_v1" => get_template_directory_uri( 'template_directory' ) . "/images/header/header_v1.jpg",
		"header_v2" => get_template_directory_uri( 'template_directory' ) . "/images/header/header_v2.jpg",
		"header_v3" => get_template_directory_uri( 'template_directory' ) . "/images/header/header_v3.jpg",
	),
	'default' => 'header_v1',
) );
